...
CREATE TABLE `tbl_jenis_bayar`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `jenis_bayar` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `tbl_jenis_bayar` VALUES (3, 'Cash');
INSERT INTO `tbl_jenis_bayar` VALUES (4, 'Kredit');
INSERT INTO `tbl_jenis_bayar` VALUES (5, 'Transfer');
...
-- ----------------------------
INSERT INTO `tbl_perjalanan` VALUES (3, 'Cilacap', 'Jogjakarta', 300, 1);
INSERT INTO `tbl_perjalanan` VALUES (4, 'Cilacap', 'Ciamis', 70, 1);
INSERT INTO `tbl_perjalanan` VALUES (7, 'Medan', 'aceh', 800, 1);
...
-- ----------------------------
INSERT INTO `tbl_pesanan` VALUES (1, 1000000, '2020-01-01', '2020-01-04', 8, 13, 3, 3, 2);
INSERT INTO `tbl_pesanan` VALUES (6, 2000000, '2020-01-17', '2020-01-20', 6, 14, 3, 3, 1);
INSERT INTO `tbl_pesanan` VALUES (8, 1500000, '2020-01-18', '2020-01-21', 7, 15, 4, 3, 1);
INSERT INTO `tbl_pesanan` VALUES (10, 700000, '2023-10-15', '2023-10-17', 10, 15, 3, 3, 1);
INSERT INTO `tbl_pesanan` VALUES (11, 250000, '2023-10-16', '2023-10-17', 7, 14, 7, 3, 1);
...
-- ----------------------------
INSERT INTO `tuangkeluar` VALUES (3, 1, 'serice rem mobil a', 250000, '2023-10-16', 4, 1, '2023-10-16 09:03:55', 4, '2023-10-16 19:12:12');
INSERT INTO `tuangkeluar` VALUES (4, 3, 'ada aaja', 51000, '2023-10-18', 4, 1, '2023-10-16 09:12:43', 4, '2023-10-16 19:12:33');
INSERT INTO `tuangkeluar` VALUES (5, 3, 'uang tempel ban', 1000, '2023-10-17', 4, 1, '2023-10-16 19:03:49', 4, '2023-10-16 19:05:18');
...
SELECT DATE_FORMAT(tgl_pinjam,'%d-%m-%Y') as tgl,sum(tbl_pesanan.harga) as nominal ,'UM' as trans,tbl_pesanan.id_perusahaanref,tgl_pinjam as tgltrans FROM `tbl_pesanan`
group by DATE_FORMAT(tgl_pinjam,'%d-%m-%Y'),tbl_pesanan.id_perusahaanref
union all
