							...
							<div class="card-body">
								...
								<div class="form-group">
								  	...
								  	<div class="form-group">
                                          ...
                                          <div class="col-md-2">
                                                <input type="text" class="form-control inputField" placeholder="harga" name="price[]" onkeyup="FormatCurrency(this)"  style="text-align: right;" >
                                          </div>
                                          <div class="col-md-1">
										...
										<!-- <input type="hidden" name="id_perjalanan" id="id_perjalanan" value='7'> -->
								  		...
								  		<div class="col-md-6">
								  			<div class="form-group">
                                                  ...
                                                  <input type="text" maxlength="15" disabled  onkeyup="FormatCurrency(this)" style="text-align: right;"  name="harga2" id="harga2" placeholder="ketik" required="required" autocomplete="off" class="form-control">
